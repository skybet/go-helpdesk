...
// Message is escaped by default according to https://api.slack.com/docs/formatting
// Use http://davestevens.github.io/slack-message-builder/ to help crafting your message.
func (api *Client) PostEphemeral(channelID, userID string, params PostEphemeralParameters) (string, error) {
...
func (api *Client) PostEphemeralContext(ctx context.Context, channelID, userID string, params PostEphemeralParameters) (string, error) {
	path, values, err := ApplyMsgOptions(
		api.Config.token,
		channelID,
		MsgOptionPostEphemeral(),
		MsgOptionAttachments(params.Attachments...),
		MsgOptionPostEphemeralParameters(params),
	)
